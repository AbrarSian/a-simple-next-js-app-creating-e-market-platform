    ...
    return (
        <section className="Featured container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-20">
            ...
            <div className="flex justify-between items-center mb-10">
                ...
                <Link
                    href="/animals"
                    className="font-semibold px-4 py-2 border border-black/10 rounded-md text-(--secondary) hover:bg-(--secondary) hover:text-white transition flex items-center gap-1"
                >
